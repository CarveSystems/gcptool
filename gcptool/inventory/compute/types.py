...
#   timestamp: 2021-11-29T16:57:10+00:00
...
class LocationPolicyLocation(BaseModel):
    preference: Optional[Preference] = Field(
        None, description='Preference for a given location: ALLOW or DENY.'
    )
...
class RouterInterface(BaseModel):
    ...
    redundant_interface: Optional[
        constr(regex=r'[a-z](?:[-a-z0-9]{0,61}[a-z0-9])?')
    ] = Field(
        None,
...
class Operation(BaseModel):
    ...
    warnings: Optional[List[Warning8]] = Field(
        None,
...
class ExchangedPeeringRoute(BaseModel):
    ...
    type: Optional[Type] = Field(None, description='The type of the peering route.')
...
class PrivateIpv6GoogleAccess1(Enum):
    enable_bidirectional_access_to_google = 'ENABLE_BIDIRECTIONAL_ACCESS_TO_GOOGLE'
    enable_outbound_vm_access_to_google = 'ENABLE_OUTBOUND_VM_ACCESS_TO_GOOGLE'
...
class SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfig(BaseModel):
    ...
    rule_visibility: Optional[NetworkTier] = Field(
        None,
...
class ResourcePolicyGroupPlacementPolicy(BaseModel):
    vm_count: Optional[int] = Field(
        None, alias='vmCount', description='Number of vms in this placement group'
    )
...
class SslPolicy(BaseModel):
    ...
    warnings: Optional[List[Warning37]] = Field(
        None,
...
class SubnetworksSetPrivateIpGoogleAccessRequest(BaseModel):
    private_ip_google_access: Optional[bool] = Field(
        None, alias='privateIpGoogleAccess'
    )
...
class ServiceAttachmentConnectedEndpoint(BaseModel):
    ...
    status: Optional[PscConnectionStatus] = Field(
        None,
...
class ShieldedInstanceIdentityEntry(BaseModel):
    ek_pub: Optional[str] = Field(
        None, alias='ekPub', description='A PEM-encoded public key.'
    )
...
class PublicAdvertisedPrefix(BaseModel):
    ...
    status: Optional[Status24] = Field(
        None, description='The status of the public advertised prefix.'
    )
    self_link: Optional[str] = Field(
        None,
        alias='selfLink',
    ...
    public_delegated_prefixs: Optional[
...
class Project(BaseModel):
    ...
    common_instance_metadata: Optional[Metadata1] = Field(
        None,
...
class NodeGroupNode(BaseModel):
    ...
    node_type: Optional[str] = Field(
        None, alias='nodeType', description='The type of this node.'
    )
...
class VmEndpointNatMappings(BaseModel):
    ...
    interface_nat_mappings: Optional[
        List[VmEndpointNatMappingsInterfaceNatMappings]
    ] = Field(None, alias='interfaceNatMappings')
...
class Route(BaseModel):
    ...
    warnings: Optional[List[Warning10]] = Field(
        None,
...
class Network(BaseModel):
    ...
    i_pv4_range: Optional[
        constr(regex=r'[0-9]{1,3}(?:\.[0-9]{1,3}){3}/[0-9]{1,2}')
    ] = Field(
        None,
        alias='IPv4Range',
...
class PublicDelegatedPrefix(BaseModel):
    ...
    status: Optional[Status11] = Field(
        None, description='[Output Only] The status of the public delegated prefix.'
    )
...
class ManagedInstance(BaseModel):
    ...
    instance_status: Optional[Status4] = Field(
        None,
...
class HealthCheck(BaseModel):
    ...
    http2_health_check: Optional[Http2HealthCheck] = Field(
        None, alias='http2HealthCheck'
    )
    healthy_threshold: Optional[int] = Field(
        None,
        alias='healthyThreshold',
    ...
    https_health_check: Optional[HttpsHealthCheck1] = Field(
        None, alias='httpsHealthCheck'
    )
    unhealthy_threshold: Optional[int] = Field(
        None,
        alias='unhealthyThreshold',
...
class InterconnectDiagnosticsLinkStatus(BaseModel):
    lacp_status: Optional[InterconnectDiagnosticsLinkLacpStatus] = Field(
        None, alias='lacpStatus'
    )
    ...
    transmitting_optical_power: Optional[
...
class RouterStatusBgpPeerStatus(BaseModel):
    ...
    state: Optional[str] = Field(None, description='BGP state as specified in RFC1771.')
    peer_ip_address: Optional[str] = Field(
        None,
        alias='peerIpAddress',
    ...
    advertised_routes: Optional[List[Route]] = Field(
        None,
...
class InstanceManagedByIgmError(BaseModel):
    ...
    instance_action_details: Optional[
...
class ForwardingRule(BaseModel):
    ...
    psc_connection_status: Optional[PscConnectionStatus] = Field(
        None, alias='pscConnectionStatus'
    )
    creation_timestamp: Optional[str] = Field(
        None,
        alias='creationTimestamp',
    ...
    load_balancing_scheme: Optional[LoadBalancingScheme] = Field(
        None,
...
class AutoscalingPolicy(BaseModel):
    ...
    custom_metric_utilizations: Optional[
...
class StatefulPolicy(BaseModel):
    preserved_state: Optional[StatefulPolicyPreservedState] = Field(
        None, alias='preservedState'
    )
...
class ResourcePolicySnapshotSchedulePolicySchedule(BaseModel):
    weekly_schedule: Optional[ResourcePolicyWeeklyCycle] = Field(
        None, alias='weeklySchedule'
    )
    daily_schedule: Optional[ResourcePolicyDailyCycle] = Field(
        None, alias='dailySchedule'
    )
    hourly_schedule: Optional[ResourcePolicyHourlyCycle] = Field(
        None, alias='hourlySchedule'
    )
...
class BackendService(BaseModel):
    ...
    connection_draining: Optional[ConnectionDraining] = Field(
        None, alias='connectionDraining'
    )
    port_name: Optional[str] = Field(
        None,
        alias='portName',
...
class InstanceProperties(BaseModel):
    ...
    private_ipv6_google_access: Optional[PrivateIpv6GoogleAccess1] = Field(
        None,
        alias='privateIpv6GoogleAccess',
...
class RouterStatus(BaseModel):
    best_routes: Optional[List[Route]] = Field(
    ...
    bgp_peer_status: Optional[List[RouterStatusBgpPeerStatus]] = Field(
        None, alias='bgpPeerStatus'
    )
    network: Optional[str] = Field(
        None, description='URI of the network to which this router belongs.'
    )
    best_routes_for_router: Optional[List[Route]] = Field(
        None,
...
class Instance(BaseModel):
    ...
    shielded_instance_integrity_policy: Optional[
        ShieldedInstanceIntegrityPolicy
    ] = Field(None, alias='shieldedInstanceIntegrityPolicy')
    service_accounts: Optional[List[ServiceAccount]] = Field(
        None,
        alias='serviceAccounts',
...
class SecurityPolicy(BaseModel):
    ...
    ] = Field(None, alias='adaptiveProtectionConfig')
...
class Model(BaseModel):
    global_network_endpoint_groups_attach_endpoints_request: Optional[
        GlobalNetworkEndpointGroupsAttachEndpointsRequest
    ] = Field(None, alias='GlobalNetworkEndpointGroupsAttachEndpointsRequest')
    ...
    vpn_gateway: Optional[VpnGateway] = Field(None, alias='VpnGateway')
    guest_attributes_value: Optional[GuestAttributesValue] = Field(
        None, alias='GuestAttributesValue'
    )
    routers_scoped_list: Optional[RoutersScopedList] = Field(
        None, alias='RoutersScopedList'
    )
    cache_key_policy: Optional[CacheKeyPolicy] = Field(None, alias='CacheKeyPolicy')
    ssl_policy_reference: Optional[SslPolicyReference] = Field(
        None, alias='SslPolicyReference'
    )
    router_status_nat_status_nat_rule_status: Optional[
        RouterStatusNatStatusNatRuleStatus
    ] = Field(None, alias='RouterStatusNatStatusNatRuleStatus')
    instance_group_managers_list_errors_response: Optional[
        InstanceGroupManagersListErrorsResponse
    ] = Field(None, alias='InstanceGroupManagersListErrorsResponse')
    ...
    operation_list: Optional[OperationList] = Field(None, alias='OperationList')
    ...
    exchanged_peering_route: Optional[ExchangedPeeringRoute] = Field(
        None, alias='ExchangedPeeringRoute'
    )
    router_nat_subnetwork_to_nat: Optional[RouterNatSubnetworkToNat] = Field(
        None, alias='RouterNatSubnetworkToNat'
    )
    network_endpoint_group_app_engine: Optional[NetworkEndpointGroupAppEngine] = Field(
        None, alias='NetworkEndpointGroupAppEngine'
    )
    region_disks_remove_resource_policies_request: Optional[
        RegionDisksRemoveResourcePoliciesRequest
    ] = Field(None, alias='RegionDisksRemoveResourcePoliciesRequest')
    route_list: Optional[RouteList] = Field(None, alias='RouteList')
    log_config: Optional[LogConfig] = Field(None, alias='LogConfig')
    autoscaling_policy_load_balancing_utilization: Optional[
        AutoscalingPolicyLoadBalancingUtilization
    ] = Field(None, alias='AutoscalingPolicyLoadBalancingUtilization')
    weighted_backend_service: Optional[WeightedBackendService] = Field(
        None, alias='WeightedBackendService'
    )
    interconnect_diagnostics_link_optical_power: Optional[
        InterconnectDiagnosticsLinkOpticalPower
    ] = Field(None, alias='InterconnectDiagnosticsLinkOpticalPower')
    ...
    target_tcp_proxy: Optional[TargetTcpProxy] = Field(None, alias='TargetTcpProxy')
    target_ssl_proxy_list: Optional[TargetSslProxyList] = Field(
        None, alias='TargetSslProxyList'
    )
    ...
    distribution_policy_zone_configuration: Optional[
        DistributionPolicyZoneConfiguration
    ] = Field(None, alias='DistributionPolicyZoneConfiguration')
    snapshot: Optional[Snapshot] = Field(None, alias='Snapshot')
    autoscaling_policy_scale_in_control: Optional[
        AutoscalingPolicyScaleInControl
    ] = Field(None, alias='AutoscalingPolicyScaleInControl')
    ...
    target_pools_add_health_check_request: Optional[
        TargetPoolsAddHealthCheckRequest
    ] = Field(None, alias='TargetPoolsAddHealthCheckRequest')
    security_policy_list: Optional[SecurityPolicyList] = Field(
        None, alias='SecurityPolicyList'
    )
    ...
    disk_instantiation_config: Optional[DiskInstantiationConfig] = Field(
        None, alias='DiskInstantiationConfig'
    )
    security_policy_adaptive_protection_config: Optional[
        SecurityPolicyAdaptiveProtectionConfig
    ] = Field(None, alias='SecurityPolicyAdaptiveProtectionConfig')
    backend_service_failover_policy: Optional[BackendServiceFailoverPolicy] = Field(
        None, alias='BackendServiceFailoverPolicy'
    )
    ...
    instance_group_manager: Optional[InstanceGroupManager] = Field(
        None, alias='InstanceGroupManager'
    )
    access_config: Optional[AccessConfig] = Field(None, alias='AccessConfig')
    networks_remove_peering_request: Optional[NetworksRemovePeeringRequest] = Field(
        None, alias='NetworksRemovePeeringRequest'
    )
    autoscaling_policy_scaling_schedule: Optional[
        AutoscalingPolicyScalingSchedule
    ] = Field(None, alias='AutoscalingPolicyScalingSchedule')
    http_header_action: Optional[HttpHeaderAction] = Field(
        None, alias='HttpHeaderAction'
    )
    ...
    firewall_policy_rule: Optional[FirewallPolicyRule] = Field(
        None, alias='FirewallPolicyRule'
    )
    external_vpn_gateway_list: Optional[ExternalVpnGatewayList] = Field(
        None, alias='ExternalVpnGatewayList'
    )
    scaling_schedule_status: Optional[ScalingScheduleStatus] = Field(
        None, alias='ScalingScheduleStatus'
    )
    ...
    public_delegated_prefix_aggregated_list: Optional[
        PublicDelegatedPrefixAggregatedList
    ] = Field(None, alias='PublicDelegatedPrefixAggregatedList')
    forwarding_rules_scoped_list: Optional[ForwardingRulesScopedList] = Field(
        None, alias='ForwardingRulesScopedList'
    )
    instance_groups_set_named_ports_request: Optional[
        InstanceGroupsSetNamedPortsRequest
    ] = Field(None, alias='InstanceGroupsSetNamedPortsRequest')
    ...
    http_fault_abort: Optional[HttpFaultAbort] = Field(None, alias='HttpFaultAbort')
    instance_group_list: Optional[InstanceGroupList] = Field(
        None, alias='InstanceGroupList'
    )
    ...
    http_redirect_action: Optional[HttpRedirectAction] = Field(
        None, alias='HttpRedirectAction'
    )
    accelerator_type_list: Optional[AcceleratorTypeList] = Field(
        None, alias='AcceleratorTypeList'
    )
    instances_set_min_cpu_platform_request: Optional[
        InstancesSetMinCpuPlatformRequest
    ] = Field(None, alias='InstancesSetMinCpuPlatformRequest')
    security_policy_reference: Optional[SecurityPolicyReference] = Field(
        None, alias='SecurityPolicyReference'
    )
    ...
    disks_add_resource_policies_request: Optional[
        DisksAddResourcePoliciesRequest
    ] = Field(None, alias='DisksAddResourcePoliciesRequest')
    https_health_check: Optional[HttpsHealthCheck] = Field(
        None, alias='HttpsHealthCheck'
    )
    instance_template: Optional[InstanceTemplate] = Field(
        None, alias='InstanceTemplate'
    )
    packet_mirroring_forwarding_rule_info: Optional[
        PacketMirroringForwardingRuleInfo
    ] = Field(None, alias='PacketMirroringForwardingRuleInfo')
    ...
    preconfigured_waf_set: Optional[PreconfiguredWafSet] = Field(
        None, alias='PreconfiguredWafSet'
    )
    router_bgp_peer_bfd: Optional[RouterBgpPeerBfd] = Field(
        None, alias='RouterBgpPeerBfd'
    )
    ...
    ssl_certificate_aggregated_list: Optional[SslCertificateAggregatedList] = Field(
        None, alias='SslCertificateAggregatedList'
    )
    region_autoscaler_list: Optional[RegionAutoscalerList] = Field(
        None, alias='RegionAutoscalerList'
    )
    ...
    machine_type: Optional[MachineType] = Field(None, alias='MachineType')
    disk_types_scoped_list: Optional[DiskTypesScopedList] = Field(
        None, alias='DiskTypesScopedList'
    )
    url_maps_scoped_list: Optional[UrlMapsScopedList] = Field(
        None, alias='UrlMapsScopedList'
    )
    ...
    usable_subnetworks_aggregated_list: Optional[
        UsableSubnetworksAggregatedList
    ] = Field(None, alias='UsableSubnetworksAggregatedList')
    ...
    target_ssl_proxy: Optional[TargetSslProxy] = Field(None, alias='TargetSslProxy')
    addresses_scoped_list: Optional[AddressesScopedList] = Field(
        None, alias='AddressesScopedList'
    )
    target_pools_add_instance_request: Optional[TargetPoolsAddInstanceRequest] = Field(
        None, alias='TargetPoolsAddInstanceRequest'
    )
    instance_group_manager_update_policy: Optional[
        InstanceGroupManagerUpdatePolicy
    ] = Field(None, alias='InstanceGroupManagerUpdatePolicy')
    ...
    instance_group_managers_abandon_instances_request: Optional[
        InstanceGroupManagersAbandonInstancesRequest
    ] = Field(None, alias='InstanceGroupManagersAbandonInstancesRequest')
    ...
    region_instance_group_managers_abandon_instances_request: Optional[
        RegionInstanceGroupManagersAbandonInstancesRequest
    ] = Field(None, alias='RegionInstanceGroupManagersAbandonInstancesRequest')
    resource_policy_aggregated_list: Optional[ResourcePolicyAggregatedList] = Field(
        None, alias='ResourcePolicyAggregatedList'
    )
    public_delegated_prefix_public_delegated_sub_prefix: Optional[
        PublicDelegatedPrefixPublicDelegatedSubPrefix
    ] = Field(None, alias='PublicDelegatedPrefixPublicDelegatedSubPrefix')
    file_content_buffer: Optional[FileContentBuffer] = Field(
        None, alias='FileContentBuffer'
    )
    test_failure: Optional[TestFailure] = Field(None, alias='TestFailure')
    external_vpn_gateway_interface: Optional[ExternalVpnGatewayInterface] = Field(
        None, alias='ExternalVpnGatewayInterface'
    )
    region_instance_group_manager_update_instance_config_req: Optional[
        RegionInstanceGroupManagerUpdateInstanceConfigReq
    ] = Field(None, alias='RegionInstanceGroupManagerUpdateInstanceConfigReq')
    http_query_parameter_match: Optional[HttpQueryParameterMatch] = Field(
        None, alias='HttpQueryParameterMatch'
    )
    ...
    network_endpoint_group_aggregated_list: Optional[
        NetworkEndpointGroupAggregatedList
    ] = Field(None, alias='NetworkEndpointGroupAggregatedList')
    instance_group_managers_delete_per_instance_configs_req: Optional[
        InstanceGroupManagersDeletePerInstanceConfigsReq
    ] = Field(None, alias='InstanceGroupManagersDeletePerInstanceConfigsReq')
    router_status_nat_status: Optional[RouterStatusNatStatus] = Field(
        None, alias='RouterStatusNatStatus'
    )
    ...
    resource_group_reference: Optional[ResourceGroupReference] = Field(
        None, alias='ResourceGroupReference'
    )
    backend_bucket: Optional[BackendBucket] = Field(None, alias='BackendBucket')
    target_http_proxy_aggregated_list: Optional[TargetHttpProxyAggregatedList] = Field(
        None, alias='TargetHttpProxyAggregatedList'
    )
    health_status_for_network_endpoint: Optional[
        HealthStatusForNetworkEndpoint
    ] = Field(None, alias='HealthStatusForNetworkEndpoint')
    autoscaler_status_details: Optional[AutoscalerStatusDetails] = Field(
        None, alias='AutoscalerStatusDetails'
    )
    condition: Optional[Condition] = Field(None, alias='Condition')
    interconnect_list: Optional[InterconnectList] = Field(
        None, alias='InterconnectList'
    )
    target_pools_remove_health_check_request: Optional[
        TargetPoolsRemoveHealthCheckRequest
    ] = Field(None, alias='TargetPoolsRemoveHealthCheckRequest')
    instance_groups_list_instances_request: Optional[
        InstanceGroupsListInstancesRequest
    ] = Field(None, alias='InstanceGroupsListInstancesRequest')
    backend_bucket_cdn_policy_negative_caching_policy: Optional[
        BackendBucketCdnPolicyNegativeCachingPolicy
    ] = Field(None, alias='BackendBucketCdnPolicyNegativeCachingPolicy')
    instance_groups_add_instances_request: Optional[
        InstanceGroupsAddInstancesRequest
    ] = Field(None, alias='InstanceGroupsAddInstancesRequest')
    ...
    external_vpn_gateway: Optional[ExternalVpnGateway] = Field(
        None, alias='ExternalVpnGateway'
    )
    ...
    public_delegated_prefixes_scoped_list: Optional[
        PublicDelegatedPrefixesScopedList
    ] = Field(None, alias='PublicDelegatedPrefixesScopedList')
    network_endpoint_groups_scoped_list: Optional[
        NetworkEndpointGroupsScopedList
    ] = Field(None, alias='NetworkEndpointGroupsScopedList')
    ...
    interconnects_get_diagnostics_response: Optional[
        InterconnectsGetDiagnosticsResponse
    ] = Field(None, alias='InterconnectsGetDiagnosticsResponse')
    resource_policy_resource_status_instance_schedule_policy_status: Optional[
        ResourcePolicyResourceStatusInstanceSchedulePolicyStatus
    ] = Field(None, alias='ResourcePolicyResourceStatusInstanceSchedulePolicyStatus')
    ...
    log_config_counter_options_custom_field: Optional[
        LogConfigCounterOptionsCustomField
    ] = Field(None, alias='LogConfigCounterOptionsCustomField')
    public_delegated_prefix_list: Optional[PublicDelegatedPrefixList] = Field(
        None, alias='PublicDelegatedPrefixList'
    )
    instance_properties: Optional[InstanceProperties] = Field(
        None, alias='InstanceProperties'
    )
    stateful_policy: Optional[StatefulPolicy] = Field(None, alias='StatefulPolicy')
    ...
    target_http_proxy_list: Optional[TargetHttpProxyList] = Field(
        None, alias='TargetHttpProxyList'
    )
    ...
    subnetworks_set_private_ip_google_access_request: Optional[
        SubnetworksSetPrivateIpGoogleAccessRequest
    ] = Field(None, alias='SubnetworksSetPrivateIpGoogleAccessRequest')
    instance_groups_list_instances: Optional[InstanceGroupsListInstances] = Field(
        None, alias='InstanceGroupsListInstances'
    )
    network_endpoint_group_cloud_function: Optional[
        NetworkEndpointGroupCloudFunction
    ] = Field(None, alias='NetworkEndpointGroupCloudFunction')
    ...
    target_pools_remove_instance_request: Optional[
        TargetPoolsRemoveInstanceRequest
    ] = Field(None, alias='TargetPoolsRemoveInstanceRequest')
    node_template_list: Optional[NodeTemplateList] = Field(
        None, alias='NodeTemplateList'
    )
    ...
    firewall_policy_list: Optional[FirewallPolicyList] = Field(
        None, alias='FirewallPolicyList'
    )
    region_instance_groups_set_named_ports_request: Optional[
        RegionInstanceGroupsSetNamedPortsRequest
    ] = Field(None, alias='RegionInstanceGroupsSetNamedPortsRequest')
    projects_disable_xpn_resource_request: Optional[
        ProjectsDisableXpnResourceRequest
    ] = Field(None, alias='ProjectsDisableXpnResourceRequest')
    ...
    address_list: Optional[AddressList] = Field(None, alias='AddressList')
    backend_bucket_cdn_policy_bypass_cache_on_request_header: Optional[
        BackendBucketCdnPolicyBypassCacheOnRequestHeader
    ] = Field(None, alias='BackendBucketCdnPolicyBypassCacheOnRequestHeader')
    zone_set_policy_request: Optional[ZoneSetPolicyRequest] = Field(
        None, alias='ZoneSetPolicyRequest'
    )
    instance_reference: Optional[InstanceReference] = Field(
        None, alias='InstanceReference'
    )
    ...
    region_instance_group_managers_set_target_pools_request: Optional[
        RegionInstanceGroupManagersSetTargetPoolsRequest
    ] = Field(None, alias='RegionInstanceGroupManagersSetTargetPoolsRequest')
    forwarding_rule_reference: Optional[ForwardingRuleReference] = Field(
        None, alias='ForwardingRuleReference'
    )
    target_grpc_proxy_list: Optional[TargetGrpcProxyList] = Field(
        None, alias='TargetGrpcProxyList'
    )
    target_grpc_proxy: Optional[TargetGrpcProxy] = Field(None, alias='TargetGrpcProxy')
    instance_group_aggregated_list: Optional[InstanceGroupAggregatedList] = Field(
        None, alias='InstanceGroupAggregatedList'
    )
    ...
    ssl_certificate_managed_ssl_certificate: Optional[
        SslCertificateManagedSslCertificate
    ] = Field(None, alias='SslCertificateManagedSslCertificate')
    ...
    service_attachment_aggregated_list: Optional[
        ServiceAttachmentAggregatedList
    ] = Field(None, alias='ServiceAttachmentAggregatedList')
    ssl_policies_list_available_features_response: Optional[
        SslPoliciesListAvailableFeaturesResponse
    ] = Field(None, alias='SslPoliciesListAvailableFeaturesResponse')
    http_fault_injection: Optional[HttpFaultInjection] = Field(
        None, alias='HttpFaultInjection'
    )
    node_groups_scoped_list: Optional[NodeGroupsScopedList] = Field(
        None, alias='NodeGroupsScopedList'
    )
    ...
    target_instances_scoped_list: Optional[TargetInstancesScopedList] = Field(
        None, alias='TargetInstancesScopedList'
    )
    route_as_path: Optional[RouteAsPath] = Field(None, alias='RouteAsPath')
    public_advertised_prefix_public_delegated_prefix: Optional[
        PublicAdvertisedPrefixPublicDelegatedPrefix
    ] = Field(None, alias='PublicAdvertisedPrefixPublicDelegatedPrefix')
    url_maps_aggregated_list: Optional[UrlMapsAggregatedList] = Field(
        None, alias='UrlMapsAggregatedList'
    )
    region_instance_group_managers_delete_instances_request: Optional[
        RegionInstanceGroupManagersDeleteInstancesRequest
    ] = Field(None, alias='RegionInstanceGroupManagersDeleteInstancesRequest')
    resource_policy_instance_schedule_policy: Optional[
        ResourcePolicyInstanceSchedulePolicy
    ] = Field(None, alias='ResourcePolicyInstanceSchedulePolicy')
    target_tcp_proxy_list: Optional[TargetTcpProxyList] = Field(
        None, alias='TargetTcpProxyList'
    )
    interconnect_attachment_partner_metadata: Optional[
        InterconnectAttachmentPartnerMetadata
    ] = Field(None, alias='InterconnectAttachmentPartnerMetadata')
    vpn_gateway_status_high_availability_requirement_state: Optional[
        VpnGatewayStatusHighAvailabilityRequirementState
    ] = Field(None, alias='VpnGatewayStatusHighAvailabilityRequirementState')
    confidential_instance_config: Optional[ConfidentialInstanceConfig] = Field(
        None, alias='ConfidentialInstanceConfig'
    )
    forwarding_rule_list: Optional[ForwardingRuleList] = Field(
        None, alias='ForwardingRuleList'
    )
    managed_instance_last_attempt: Optional[ManagedInstanceLastAttempt] = Field(
        None, alias='ManagedInstanceLastAttempt'
    )
    ...
    usage_export_location: Optional[UsageExportLocation] = Field(
        None, alias='UsageExportLocation'
    )
    target_pool_aggregated_list: Optional[TargetPoolAggregatedList] = Field(
        None, alias='TargetPoolAggregatedList'
    )
    security_policy_advanced_options_config: Optional[
        SecurityPolicyAdvancedOptionsConfig
    ] = Field(None, alias='SecurityPolicyAdvancedOptionsConfig')
    serial_port_output: Optional[SerialPortOutput] = Field(
        None, alias='SerialPortOutput'
    )
    resource_policy_snapshot_schedule_policy_schedule: Optional[
        ResourcePolicySnapshotSchedulePolicySchedule
    ] = Field(None, alias='ResourcePolicySnapshotSchedulePolicySchedule')
    ...
    machine_types_scoped_list: Optional[MachineTypesScopedList] = Field(
        None, alias='MachineTypesScopedList'
    )
    http_header_option: Optional[HttpHeaderOption] = Field(
        None, alias='HttpHeaderOption'
    )
    authorization_logging_options: Optional[AuthorizationLoggingOptions] = Field(
        None, alias='AuthorizationLoggingOptions'
    )
    health_check_list: Optional[HealthCheckList] = Field(None, alias='HealthCheckList')
    policy: Optional[Policy1] = Field(None, alias='Policy')
    interconnect_diagnostics: Optional[InterconnectDiagnostics] = Field(
        None, alias='InterconnectDiagnostics'
    )
    network_peering: Optional[NetworkPeering] = Field(None, alias='NetworkPeering')
    ...
    vpn_gateway_status: Optional[VpnGatewayStatus] = Field(
        None, alias='VpnGatewayStatus'
    )
    ...
    interconnect_attachment: Optional[InterconnectAttachment] = Field(
        None, alias='InterconnectAttachment'
    )
    health_check_service: Optional[HealthCheckService] = Field(
        None, alias='HealthCheckService'
    )
    ...
    instance_group_managers_set_instance_template_request: Optional[
        InstanceGroupManagersSetInstanceTemplateRequest
    ] = Field(None, alias='InstanceGroupManagersSetInstanceTemplateRequest')
    license_resource_requirements: Optional[LicenseResourceRequirements] = Field(
        None, alias='LicenseResourceRequirements'
    )
    instance_group_manager_status_stateful_per_instance_configs: Optional[
        InstanceGroupManagerStatusStatefulPerInstanceConfigs
    ] = Field(None, alias='InstanceGroupManagerStatusStatefulPerInstanceConfigs')
    ...
    disk_type_aggregated_list: Optional[DiskTypeAggregatedList] = Field(
        None, alias='DiskTypeAggregatedList'
    )
    firewall: Optional[Firewall] = Field(None, alias='Firewall')
    ...
    reservation_list: Optional[ReservationList] = Field(None, alias='ReservationList')
    vpn_tunnel_aggregated_list: Optional[VpnTunnelAggregatedList] = Field(
        None, alias='VpnTunnelAggregatedList'
    )
    interconnect_attachment_private_info: Optional[
        InterconnectAttachmentPrivateInfo
    ] = Field(None, alias='InterconnectAttachmentPrivateInfo')
    region_instance_group_manager_list: Optional[
        RegionInstanceGroupManagerList
    ] = Field(None, alias='RegionInstanceGroupManagerList')
    firewall_policy: Optional[FirewallPolicy] = Field(None, alias='FirewallPolicy')
    region_instance_group_list: Optional[RegionInstanceGroupList] = Field(
        None, alias='RegionInstanceGroupList'
    )
    interconnect_circuit_info: Optional[InterconnectCircuitInfo] = Field(
        None, alias='InterconnectCircuitInfo'
    )
    url_map_list: Optional[UrlMapList] = Field(None, alias='UrlMapList')
    audit_log_config: Optional[AuditLogConfig] = Field(None, alias='AuditLogConfig')
    instance_group_manager_auto_healing_policy: Optional[
        InstanceGroupManagerAutoHealingPolicy
    ] = Field(None, alias='InstanceGroupManagerAutoHealingPolicy')
    allocation_specific_sku_reservation: Optional[
        AllocationSpecificSkuReservation
    ] = Field(None, alias='AllocationSpecificSKUReservation')
    interconnect_diagnostics_arp_entry: Optional[
        InterconnectDiagnosticsArpEntry
    ] = Field(None, alias='InterconnectDiagnosticsARPEntry')
    ...
    url_map_test_header: Optional[UrlMapTestHeader] = Field(
        None, alias='UrlMapTestHeader'
    )
    shielded_instance_integrity_policy: Optional[
        ShieldedInstanceIntegrityPolicy
    ] = Field(None, alias='ShieldedInstanceIntegrityPolicy')
    attached_disk: Optional[AttachedDisk] = Field(None, alias='AttachedDisk')
    autoscaling_policy_cpu_utilization: Optional[
        AutoscalingPolicyCpuUtilization
    ] = Field(None, alias='AutoscalingPolicyCpuUtilization')
    security_settings: Optional[SecuritySettings] = Field(
        None, alias='SecuritySettings'
    )
    ...
    router_advertised_ip_range: Optional[RouterAdvertisedIpRange] = Field(
        None, alias='RouterAdvertisedIpRange'
    )
    ...
    forwarding_rule: Optional[ForwardingRule] = Field(None, alias='ForwardingRule')
    license: Optional[License] = Field(None, alias='License')
    ...
    interconnect_attachment_aggregated_list: Optional[
        InterconnectAttachmentAggregatedList
    ] = Field(None, alias='InterconnectAttachmentAggregatedList')
    health_check_service_reference: Optional[HealthCheckServiceReference] = Field(
        None, alias='HealthCheckServiceReference'
    )
    target_instance_aggregated_list: Optional[TargetInstanceAggregatedList] = Field(
        None, alias='TargetInstanceAggregatedList'
    )
    security_policy_rule: Optional[SecurityPolicyRule] = Field(
        None, alias='SecurityPolicyRule'
    )
    instances_get_effective_firewalls_response_effective_firewall_policy: Optional[
        InstancesGetEffectiveFirewallsResponseEffectiveFirewallPolicy
    ] = Field(
        None, alias='InstancesGetEffectiveFirewallsResponseEffectiveFirewallPolicy'
    )
    ...
    backend_service_group_health: Optional[BackendServiceGroupHealth] = Field(
        None, alias='BackendServiceGroupHealth'
    )
    https_health_check_1: Optional[HttpsHealthCheck1] = Field(
        None, alias='HTTPSHealthCheck'
    )
    notification_endpoint: Optional[NotificationEndpoint] = Field(
        None, alias='NotificationEndpoint'
    )
    router_nat_log_config: Optional[RouterNatLogConfig] = Field(
        None, alias='RouterNatLogConfig'
    )
    preserved_state_preserved_disk: Optional[PreservedStatePreservedDisk] = Field(
        None, alias='PreservedStatePreservedDisk'
    )
    projects_set_default_network_tier_request: Optional[
        ProjectsSetDefaultNetworkTierRequest
    ] = Field(None, alias='ProjectsSetDefaultNetworkTierRequest')
    tags: Optional[Tags] = Field(None, alias='Tags')
    ...
    path_matcher: Optional[PathMatcher] = Field(None, alias='PathMatcher')
    autoscaler: Optional[Autoscaler] = Field(None, alias='Autoscaler')
    ...
    resource_commitment: Optional[ResourceCommitment] = Field(
        None, alias='ResourceCommitment'
    )
    notification_endpoint_grpc_settings: Optional[
        NotificationEndpointGrpcSettings
    ] = Field(None, alias='NotificationEndpointGrpcSettings')
    http_header_match: Optional[HttpHeaderMatch] = Field(None, alias='HttpHeaderMatch')
    display_device: Optional[DisplayDevice] = Field(None, alias='DisplayDevice')
    url_map: Optional[UrlMap] = Field(None, alias='UrlMap')
    guest_attributes_entry: Optional[GuestAttributesEntry] = Field(
        None, alias='GuestAttributesEntry'
    )
    shielded_instance_identity_entry: Optional[ShieldedInstanceIdentityEntry] = Field(
        None, alias='ShieldedInstanceIdentityEntry'
    )
    ...
    network: Optional[Network] = Field(None, alias='Network')
    target_instance: Optional[TargetInstance] = Field(None, alias='TargetInstance')
    instances_set_machine_type_request: Optional[
        InstancesSetMachineTypeRequest
    ] = Field(None, alias='InstancesSetMachineTypeRequest')
    backend: Optional[Backend] = Field(None, alias='Backend')
    target_ssl_proxies_set_backend_service_request: Optional[
        TargetSslProxiesSetBackendServiceRequest
    ] = Field(None, alias='TargetSslProxiesSetBackendServiceRequest')
    packet_mirroring_aggregated_list: Optional[PacketMirroringAggregatedList] = Field(
        None, alias='PacketMirroringAggregatedList'
    )
    ...
    per_instance_config: Optional[PerInstanceConfig] = Field(
        None, alias='PerInstanceConfig'
    )
    vpn_gateway_status_vpn_connection: Optional[VpnGatewayStatusVpnConnection] = Field(
        None, alias='VpnGatewayStatusVpnConnection'
    )
    instance_group_managers_set_target_pools_request: Optional[
        InstanceGroupManagersSetTargetPoolsRequest
    ] = Field(None, alias='InstanceGroupManagersSetTargetPoolsRequest')
    target_reference: Optional[TargetReference] = Field(None, alias='TargetReference')
    machine_type_list: Optional[MachineTypeList] = Field(None, alias='MachineTypeList')
    subnetworks_expand_ip_cidr_range_request: Optional[
        SubnetworksExpandIpCidrRangeRequest
    ] = Field(None, alias='SubnetworksExpandIpCidrRangeRequest')
    commitment_list: Optional[CommitmentList] = Field(None, alias='CommitmentList')
    scheduling: Optional[Scheduling] = Field(None, alias='Scheduling')
    ...
    accelerator_config: Optional[AcceleratorConfig] = Field(
        None, alias='AcceleratorConfig'
    )
    interconnect_attachments_scoped_list: Optional[
        InterconnectAttachmentsScopedList
    ] = Field(None, alias='InterconnectAttachmentsScopedList')
    ...
    accelerator_type_aggregated_list: Optional[AcceleratorTypeAggregatedList] = Field(
        None, alias='AcceleratorTypeAggregatedList'
    )
    ...
    consistent_hash_load_balancer_settings: Optional[
        ConsistentHashLoadBalancerSettings
    ] = Field(None, alias='ConsistentHashLoadBalancerSettings')
    ...
    resource_policy_group_placement_policy: Optional[
        ResourcePolicyGroupPlacementPolicy
    ] = Field(None, alias='ResourcePolicyGroupPlacementPolicy')
    region_disks_add_resource_policies_request: Optional[
        RegionDisksAddResourcePoliciesRequest
    ] = Field(None, alias='RegionDisksAddResourcePoliciesRequest')
    ...
    packet_mirroring_list: Optional[PacketMirroringList] = Field(
        None, alias='PacketMirroringList'
    )
    region_disks_resize_request: Optional[RegionDisksResizeRequest] = Field(
        None, alias='RegionDisksResizeRequest'
    )
    node_template_node_type_flexibility: Optional[
        NodeTemplateNodeTypeFlexibility
    ] = Field(None, alias='NodeTemplateNodeTypeFlexibility')
    ...
    router_status: Optional[RouterStatus] = Field(None, alias='RouterStatus')
    ...
    instances_set_labels_request: Optional[InstancesSetLabelsRequest] = Field(
        None, alias='InstancesSetLabelsRequest'
    )
    metadata_filter_label_match: Optional[MetadataFilterLabelMatch] = Field(
        None, alias='MetadataFilterLabelMatch'
    )
    global_organization_set_policy_request: Optional[
        GlobalOrganizationSetPolicyRequest
    ] = Field(None, alias='GlobalOrganizationSetPolicyRequest')
    screenshot: Optional[Screenshot] = Field(None, alias='Screenshot')
    security_policy_adaptive_protection_config_layer7_ddos_defense_config: Optional[
        SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfig
    ] = Field(
        None, alias='SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfig'
    )
    ...
    subnetwork_log_config: Optional[SubnetworkLogConfig] = Field(
        None, alias='SubnetworkLogConfig'
    )
    network_endpoint_with_health_status: Optional[
        NetworkEndpointWithHealthStatus
    ] = Field(None, alias='NetworkEndpointWithHealthStatus')
    metadata: Optional[Metadata1] = Field(None, alias='Metadata')
    log_config_data_access_options: Optional[LogConfigDataAccessOptions] = Field(
        None, alias='LogConfigDataAccessOptions'
    )
    health_checks_scoped_list: Optional[HealthChecksScopedList] = Field(
        None, alias='HealthChecksScopedList'
    )
    ...
    http_route_rule_match: Optional[HttpRouteRuleMatch] = Field(
        None, alias='HttpRouteRuleMatch'
    )
    router_bgp: Optional[RouterBgp] = Field(None, alias='RouterBgp')
    region_disk_type_list: Optional[RegionDiskTypeList] = Field(
        None, alias='RegionDiskTypeList'
    )
    request_mirror_policy: Optional[RequestMirrorPolicy] = Field(
        None, alias='RequestMirrorPolicy'
    )
    fixed_or_percent: Optional[FixedOrPercent] = Field(None, alias='FixedOrPercent')
    waf_expression_set: Optional[WafExpressionSet] = Field(
        None, alias='WafExpressionSet'
    )
    accelerator_type: Optional[AcceleratorType] = Field(None, alias='AcceleratorType')
    distribution_policy: Optional[DistributionPolicy] = Field(
        None, alias='DistributionPolicy'
    )
    target_vpn_gateway: Optional[TargetVpnGateway] = Field(
        None, alias='TargetVpnGateway'
    )
    ...
    networks_get_effective_firewalls_response_effective_firewall_policy: Optional[
        ...
        None, alias='NetworksGetEffectiveFirewallsResponseEffectiveFirewallPolicy'
    )
    zone_list: Optional[ZoneList] = Field(None, alias='ZoneList')
    networks_add_peering_request: Optional[NetworksAddPeeringRequest] = Field(
        None, alias='NetworksAddPeeringRequest'
    )
    licenses_list_response: Optional[LicensesListResponse] = Field(
        None, alias='LicensesListResponse'
    )
    instance_with_named_ports: Optional[InstanceWithNamedPorts] = Field(
        None, alias='InstanceWithNamedPorts'
    )
    target_vpn_gateway_aggregated_list: Optional[
        TargetVpnGatewayAggregatedList
    ] = Field(None, alias='TargetVpnGatewayAggregatedList')
    instance_group_manager_aggregated_list: Optional[
        InstanceGroupManagerAggregatedList
    ] = Field(None, alias='InstanceGroupManagerAggregatedList')
    service_attachment_connected_endpoint: Optional[
        ServiceAttachmentConnectedEndpoint
    ] = Field(None, alias='ServiceAttachmentConnectedEndpoint')
    ...
    disks_remove_resource_policies_request: Optional[
        DisksRemoveResourcePoliciesRequest
    ] = Field(None, alias='DisksRemoveResourcePoliciesRequest')
    instance_groups_scoped_list: Optional[InstanceGroupsScopedList] = Field(
        None, alias='InstanceGroupsScopedList'
    )
    ...
    disk_type_list: Optional[DiskTypeList] = Field(None, alias='DiskTypeList')
    ssl_certificates_scoped_list: Optional[SslCertificatesScopedList] = Field(
        None, alias='SslCertificatesScopedList'
    )
    backend_service_list: Optional[BackendServiceList] = Field(
        None, alias='BackendServiceList'
    )
    interconnect_diagnostics_link_status: Optional[
        InterconnectDiagnosticsLinkStatus
    ] = Field(None, alias='InterconnectDiagnosticsLinkStatus')
    instance_group_manager_actions_summary: Optional[
        InstanceGroupManagerActionsSummary
    ] = Field(None, alias='InstanceGroupManagerActionsSummary')
    instance_group: Optional[InstanceGroup] = Field(None, alias='InstanceGroup')
    interconnect: Optional[Interconnect] = Field(None, alias='Interconnect')
    ...
    initial_state_config: Optional[InitialStateConfig] = Field(
        None, alias='InitialStateConfig'
    )
    node_groups_set_node_template_request: Optional[
        NodeGroupsSetNodeTemplateRequest
    ] = Field(None, alias='NodeGroupsSetNodeTemplateRequest')
    disk: Optional[Disk] = Field(None, alias='Disk')
    ...
    target_https_proxy: Optional[TargetHttpsProxy] = Field(
        None, alias='TargetHttpsProxy'
    )
    backend_service_iap: Optional[BackendServiceIap] = Field(
        None, alias='BackendServiceIAP'
    )
    network_endpoint_groups_list_endpoints_request: Optional[
        NetworkEndpointGroupsListEndpointsRequest
    ] = Field(None, alias='NetworkEndpointGroupsListEndpointsRequest')
    reservation_affinity: Optional[ReservationAffinity] = Field(
        None, alias='ReservationAffinity'
    )
    autoscaling_policy: Optional[AutoscalingPolicy] = Field(
        None, alias='AutoscalingPolicy'
    )
    public_delegated_prefix: Optional[PublicDelegatedPrefix] = Field(
        None, alias='PublicDelegatedPrefix'
    )
    ...
    network_endpoint_groups_attach_endpoints_request: Optional[
        NetworkEndpointGroupsAttachEndpointsRequest
    ] = Field(None, alias='NetworkEndpointGroupsAttachEndpointsRequest')
    router_bgp_peer: Optional[RouterBgpPeer] = Field(None, alias='RouterBgpPeer')
    http2_health_check: Optional[Http2HealthCheck] = Field(
        None, alias='HTTP2HealthCheck'
    )
    resource_policy_list: Optional[ResourcePolicyList] = Field(
        None, alias='ResourcePolicyList'
    )
    vpn_gateway_status_tunnel: Optional[VpnGatewayStatusTunnel] = Field(
        None, alias='VpnGatewayStatusTunnel'
    )
    ...
    firewall_log_config: Optional[FirewallLogConfig] = Field(
        None, alias='FirewallLogConfig'
    )
    ...
    instance_move_request: Optional[InstanceMoveRequest] = Field(
        None, alias='InstanceMoveRequest'
    )
    node_group_node: Optional[NodeGroupNode] = Field(None, alias='NodeGroupNode')
    target_vpn_gateways_scoped_list: Optional[TargetVpnGatewaysScopedList] = Field(
        None, alias='TargetVpnGatewaysScopedList'
    )
    service_attachment: Optional[ServiceAttachment] = Field(
        None, alias='ServiceAttachment'
    )
    ...
    managed_instance_version: Optional[ManagedInstanceVersion] = Field(
        None, alias='ManagedInstanceVersion'
    )
    vpn_tunnel: Optional[VpnTunnel] = Field(None, alias='VpnTunnel')
    instances_set_service_account_request: Optional[
        InstancesSetServiceAccountRequest
    ] = Field(None, alias='InstancesSetServiceAccountRequest')
    url_map_reference: Optional[UrlMapReference] = Field(None, alias='UrlMapReference')
    guest_attributes: Optional[GuestAttributes] = Field(None, alias='GuestAttributes')
    disks_resize_request: Optional[DisksResizeRequest] = Field(
        None, alias='DisksResizeRequest'
    )
    tcp_health_check: Optional[TcpHealthCheck] = Field(None, alias='TCPHealthCheck')
    health_status: Optional[HealthStatus] = Field(None, alias='HealthStatus')
    xpn_resource_id: Optional[XpnResourceId] = Field(None, alias='XpnResourceId')
    region_instance_groups_list_instances: Optional[
        RegionInstanceGroupsListInstances
    ] = Field(None, alias='RegionInstanceGroupsListInstances')
    ...
    path_rule: Optional[PathRule] = Field(None, alias='PathRule')
    instances_scoped_list: Optional[InstancesScopedList] = Field(
        None, alias='InstancesScopedList'
    )
    ...
    http_health_check_1: Optional[HttpHealthCheck1] = Field(
        None, alias='HttpHealthCheck'
    )
    router_status_bgp_peer_status: Optional[RouterStatusBgpPeerStatus] = Field(
        None, alias='RouterStatusBgpPeerStatus'
    )
    resource_policy_daily_cycle: Optional[ResourcePolicyDailyCycle] = Field(
        None, alias='ResourcePolicyDailyCycle'
    )
    security_policy_rule_matcher_config: Optional[
        SecurityPolicyRuleMatcherConfig
    ] = Field(None, alias='SecurityPolicyRuleMatcherConfig')
    instance_group_managers_scoped_list: Optional[
        InstanceGroupManagersScopedList
    ] = Field(None, alias='InstanceGroupManagersScopedList')
    ...
    ssl_certificate_list: Optional[SslCertificateList] = Field(
        None, alias='SslCertificateList'
    )
    attached_disk_initialize_params: Optional[AttachedDiskInitializeParams] = Field(
        None, alias='AttachedDiskInitializeParams'
    )
    guest_os_feature: Optional[GuestOsFeature] = Field(None, alias='GuestOsFeature')
    location_policy: Optional[LocationPolicy] = Field(None, alias='LocationPolicy')
    autoscalers_scoped_list: Optional[AutoscalersScopedList] = Field(
        None, alias='AutoscalersScopedList'
    )
    target_tcp_proxies_set_proxy_header_request: Optional[
        TargetTcpProxiesSetProxyHeaderRequest
    ] = Field(None, alias='TargetTcpProxiesSetProxyHeaderRequest')
    reservation: Optional[Reservation] = Field(None, alias='Reservation')
    local_disk: Optional[LocalDisk] = Field(None, alias='LocalDisk')
    vpn_tunnel_list: Optional[VpnTunnelList] = Field(None, alias='VpnTunnelList')
    ...
    instances_set_machine_resources_request: Optional[
        InstancesSetMachineResourcesRequest
    ] = Field(None, alias='InstancesSetMachineResourcesRequest')
    usable_subnetwork: Optional[UsableSubnetwork] = Field(
        None, alias='UsableSubnetwork'
    )
    bulk_insert_instance_resource: Optional[BulkInsertInstanceResource] = Field(
        None, alias='BulkInsertInstanceResource'
    )
    instance_group_manager_status_stateful: Optional[
        InstanceGroupManagerStatusStateful
    ] = Field(None, alias='InstanceGroupManagerStatusStateful')
    https_health_check_list: Optional[HttpsHealthCheckList] = Field(
        None, alias='HttpsHealthCheckList'
    )
    exchanged_peering_routes_list: Optional[ExchangedPeeringRoutesList] = Field(
        None, alias='ExchangedPeeringRoutesList'
    )
    node_type_list: Optional[NodeTypeList] = Field(None, alias='NodeTypeList')
    backend_service_aggregated_list: Optional[BackendServiceAggregatedList] = Field(
        None, alias='BackendServiceAggregatedList'
    )
    route: Optional[Route] = Field(None, alias='Route')
    http_health_check_list: Optional[HttpHealthCheckList] = Field(
        None, alias='HttpHealthCheckList'
    )
    target_instance_list: Optional[TargetInstanceList] = Field(
        None, alias='TargetInstanceList'
    )
    resource_policy_weekly_cycle_day_of_week: Optional[
        ResourcePolicyWeeklyCycleDayOfWeek
    ] = Field(None, alias='ResourcePolicyWeeklyCycleDayOfWeek')
    packet_mirrorings_scoped_list: Optional[PacketMirroringsScopedList] = Field(
        None, alias='PacketMirroringsScopedList'
    )
    security_policies_waf_config: Optional[SecurityPoliciesWafConfig] = Field(
        None, alias='SecurityPoliciesWafConfig'
    )
    node_types_scoped_list: Optional[NodeTypesScopedList] = Field(
        None, alias='NodeTypesScopedList'
    )
    circuit_breakers: Optional[CircuitBreakers] = Field(None, alias='CircuitBreakers')
    ...
    backend_bucket_list: Optional[BackendBucketList] = Field(
        None, alias='BackendBucketList'
    )
    service_attachment_list: Optional[ServiceAttachmentList] = Field(
        None, alias='ServiceAttachmentList'
    )
    customer_encryption_key_protected_disk: Optional[
        CustomerEncryptionKeyProtectedDisk
    ] = Field(None, alias='CustomerEncryptionKeyProtectedDisk')
    disk_aggregated_list: Optional[DiskAggregatedList] = Field(
        None, alias='DiskAggregatedList'
    )
    machine_type_aggregated_list: Optional[MachineTypeAggregatedList] = Field(
        None, alias='MachineTypeAggregatedList'
    )
    security_policy: Optional[SecurityPolicy] = Field(None, alias='SecurityPolicy')
    node_groups_list_nodes: Optional[NodeGroupsListNodes] = Field(
        None, alias='NodeGroupsListNodes'
    )
    router_nat_rule_action: Optional[RouterNatRuleAction] = Field(
        None, alias='RouterNatRuleAction'
    )
    ...
    target_https_proxy_aggregated_list: Optional[
        TargetHttpsProxyAggregatedList
    ] = Field(None, alias='TargetHttpsProxyAggregatedList')
    outlier_detection: Optional[OutlierDetection] = Field(
        None, alias='OutlierDetection'
    )
    backend_service_reference: Optional[BackendServiceReference] = Field(
        None, alias='BackendServiceReference'
    )
    packet_mirroring_mirrored_resource_info: Optional[
        PacketMirroringMirroredResourceInfo
    ] = Field(None, alias='PacketMirroringMirroredResourceInfo')
    target_https_proxies_set_ssl_certificates_request: Optional[
        TargetHttpsProxiesSetSslCertificatesRequest
    ] = Field(None, alias='TargetHttpsProxiesSetSslCertificatesRequest')
    service_attachments_scoped_list: Optional[ServiceAttachmentsScopedList] = Field(
        None, alias='ServiceAttachmentsScopedList'
    )
    target_http_proxy: Optional[TargetHttpProxy] = Field(None, alias='TargetHttpProxy')
    ...
    signed_url_key: Optional[SignedUrlKey] = Field(None, alias='SignedUrlKey')
    log_config_counter_options: Optional[LogConfigCounterOptions] = Field(
        None, alias='LogConfigCounterOptions'
    )
    health_check_reference: Optional[HealthCheckReference] = Field(
        None, alias='HealthCheckReference'
    )
    http_retry_policy: Optional[HttpRetryPolicy] = Field(None, alias='HttpRetryPolicy')
    instances_add_resource_policies_request: Optional[
        InstancesAddResourcePoliciesRequest
    ] = Field(None, alias='InstancesAddResourcePoliciesRequest')
    ...
    vpn_gateway_aggregated_list: Optional[VpnGatewayAggregatedList] = Field(
        None, alias='VpnGatewayAggregatedList'
    )
    projects_enable_xpn_resource_request: Optional[
        ProjectsEnableXpnResourceRequest
    ] = Field(None, alias='ProjectsEnableXpnResourceRequest')
