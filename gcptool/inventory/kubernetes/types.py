...
class UpdateNodePoolRequest(BaseModel):
    gcfs_config: Optional[GcfsConfig] = Field(
        None, alias='gcfsConfig', description='GCFS config.'
    )
...
class NodePool(BaseModel):
    version: Optional[str] = Field(
        None, description='The version of the Kubernetes of this node.'
    )
...
class ClusterAutoscaling(BaseModel):
    ...
    autoprovisioning_node_pool_defaults: Optional[
...
class ClusterUpdate(BaseModel):
    ...
    desired_master_authorized_networks_config: Optional[
...
class Model(BaseModel):
    autoprovisioning_node_pool_defaults: Optional[
        AutoprovisioningNodePoolDefaults
    ] = Field(None, alias='AutoprovisioningNodePoolDefaults')
    linux_node_config: Optional[LinuxNodeConfig] = Field(None, alias='LinuxNodeConfig')
    big_query_destination: Optional[BigQueryDestination] = Field(
        None, alias='BigQueryDestination'
    )
    cluster_telemetry: Optional[ClusterTelemetry] = Field(
        None, alias='ClusterTelemetry'
    )
    ...
    recurring_time_window: Optional[RecurringTimeWindow] = Field(
        None, alias='RecurringTimeWindow'
    )
    private_cluster_master_global_access_config: Optional[
        PrivateClusterMasterGlobalAccessConfig
    ] = Field(None, alias='PrivateClusterMasterGlobalAccessConfig')
    set_locations_request: Optional[SetLocationsRequest] = Field(
        None, alias='SetLocationsRequest'
    )
    ...
    update_master_request: Optional[UpdateMasterRequest] = Field(
        None, alias='UpdateMasterRequest'
    )
    ...
    node_pool_autoscaling: Optional[NodePoolAutoscaling] = Field(
        None, alias='NodePoolAutoscaling'
    )
    ...
    ip_allocation_policy: Optional[IpAllocationPolicy] = Field(
        None, alias='IPAllocationPolicy'
    )
    network_policy_config: Optional[NetworkPolicyConfig] = Field(
        None, alias='NetworkPolicyConfig'
    )
    ...
    node_kubelet_config: Optional[NodeKubeletConfig] = Field(
        None, alias='NodeKubeletConfig'
    )
    ...
    gce_persistent_disk_csi_driver_config: Optional[
        GcePersistentDiskCsiDriverConfig
    ] = Field(None, alias='GcePersistentDiskCsiDriverConfig')
    ...
    http_load_balancing: Optional[HttpLoadBalancing] = Field(
        None, alias='HttpLoadBalancing'
    )
    daily_maintenance_window: Optional[DailyMaintenanceWindow] = Field(
        None, alias='DailyMaintenanceWindow'
    )
    available_version: Optional[AvailableVersion] = Field(
        None, alias='AvailableVersion'
    )
    ...
    ilb_subsetting_config: Optional[IlbSubsettingConfig] = Field(
        None, alias='ILBSubsettingConfig'
    )
    advanced_machine_features: Optional[AdvancedMachineFeatures] = Field(
    ...
    node_network_config: Optional[NodeNetworkConfig] = Field(
        None, alias='NodeNetworkConfig'
    )
    database_encryption: Optional[DatabaseEncryption] = Field(
        None, alias='DatabaseEncryption'
    )
    ...
    default_snat_status: Optional[DefaultSnatStatus] = Field(
        None, alias='DefaultSnatStatus'
    )
    vertical_pod_autoscaling: Optional[VerticalPodAutoscaling] = Field(
        None, alias='VerticalPodAutoscaling'
    )
    operation_progress: Optional[OperationProgress] = Field(
        None, alias='OperationProgress'
    )
    set_legacy_abac_request: Optional[SetLegacyAbacRequest] = Field(
        None, alias='SetLegacyAbacRequest'
    )
    auto_upgrade_options: Optional[AutoUpgradeOptions] = Field(
        None, alias='AutoUpgradeOptions'
    )
    managed_prometheus_config: Optional[ManagedPrometheusConfig] = Field(
        None, alias='ManagedPrometheusConfig'
    )
    set_labels_request: Optional[SetLabelsRequest] = Field(
        None, alias='SetLabelsRequest'
    )
    ...
    kubernetes_dashboard: Optional[KubernetesDashboard] = Field(
        None, alias='KubernetesDashboard'
    )
    notification_config: Optional[NotificationConfig] = Field(
    ...
    binary_authorization: Optional[BinaryAuthorization] = Field(
        None, alias='BinaryAuthorization'
    )
    cluster_autoscaling: Optional[ClusterAutoscaling] = Field(
        None, alias='ClusterAutoscaling'
    )
    rollback_node_pool_upgrade_request: Optional[
        RollbackNodePoolUpgradeRequest
    ] = Field(None, alias='RollbackNodePoolUpgradeRequest')
    resource_usage_export_config: Optional[ResourceUsageExportConfig] = Field(
