...
class SetOrgPolicyRequest(BaseModel):
    policy: Optional[OrgPolicy] = Field(
        None, description='`Policy` to set on the resource.'
    )
...
class Model(BaseModel):
    ...
    get_iam_policy_request: Optional[GetIamPolicyRequest] = Field(
        None, alias='GetIamPolicyRequest'
    )
    ...
    get_policy_options: Optional[GetPolicyOptions] = Field(
        None, alias='GetPolicyOptions'
    )
    get_ancestry_response: Optional[GetAncestryResponse] = Field(
        None, alias='GetAncestryResponse'
    )
    organization_owner: Optional[OrganizationOwner] = Field(
        None, alias='OrganizationOwner'
    )
    ...
    move_project_metadata: Optional[MoveProjectMetadata] = Field(
        None, alias='MoveProjectMetadata'
    )
    undelete_organization_metadata: Optional[UndeleteOrganizationMetadata] = Field(
        None, alias='UndeleteOrganizationMetadata'
    )
    move_folder_metadata: Optional[MoveFolderMetadata] = Field(
        None, alias='MoveFolderMetadata'
    )
    ...
    get_org_policy_request: Optional[GetOrgPolicyRequest] = Field(
        None, alias='GetOrgPolicyRequest'
    )
    ...
    boolean_constraint: Optional[BooleanConstraint] = Field(
        None, alias='BooleanConstraint'
    )
    delete_organization_metadata: Optional[DeleteOrganizationMetadata] = Field(
        None, alias='DeleteOrganizationMetadata'
    )
    list_liens_response: Optional[ListLiensResponse] = Field(
        None, alias='ListLiensResponse'
    )
    ...
    set_org_policy_request: Optional[SetOrgPolicyRequest] = Field(
        None, alias='SetOrgPolicyRequest'
    )
    ...
    get_ancestry_request: Optional[GetAncestryRequest] = Field(
        None, alias='GetAncestryRequest'
    )
