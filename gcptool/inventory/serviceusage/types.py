...
class FieldModel(BaseModel):
    ...
    json_name: Optional[str] = Field(
        None, alias='jsonName', description='The field JSON name.'
    )
...
class Model(BaseModel):
    ...
    metric_descriptor: Optional[MetricDescriptor] = Field(
        None, alias='MetricDescriptor'
    )
    delete_admin_quota_policy_metadata: Optional[
        DeleteAdminQuotaPolicyMetadata
    ] = Field(None, alias='DeleteAdminQuotaPolicyMetadata')
    ...
    update_admin_quota_policy_metadata: Optional[
        UpdateAdminQuotaPolicyMetadata
    ] = Field(None, alias='UpdateAdminQuotaPolicyMetadata')
    billing_destination: Optional[BillingDestination] = Field(
        None, alias='BillingDestination'
    )
    logging: Optional[Logging] = Field(None, alias='Logging')
    google_api_service: Optional[GoogleApiService] = Field(
        None, alias='GoogleApiService'
    )
    metric_descriptor_metadata: Optional[MetricDescriptorMetadata] = Field(
        None, alias='MetricDescriptorMetadata'
    )
    documentation_rule: Optional[DocumentationRule] = Field(
        None, alias='DocumentationRule'
    )
    ...
    import_consumer_overrides_response: Optional[
        ImportConsumerOverridesResponse
    ] = Field(None, alias='ImportConsumerOverridesResponse')
    enable_service_response: Optional[EnableServiceResponse] = Field(
        None, alias='EnableServiceResponse'
    )
    admin_quota_policy: Optional[AdminQuotaPolicy] = Field(
        None, alias='AdminQuotaPolicy'
    )
    custom_http_pattern: Optional[CustomHttpPattern] = Field(
        None, alias='CustomHttpPattern'
    )
    backend: Optional[Backend] = Field(None, alias='Backend')
    operation: Optional[Operation] = Field(None, alias='Operation')
    google_api_serviceusage_v1_service: Optional[
        GoogleApiServiceusageV1Service
    ] = Field(None, alias='GoogleApiServiceusageV1Service')
    ...
    import_consumer_overrides_metadata: Optional[
        ImportConsumerOverridesMetadata
    ] = Field(None, alias='ImportConsumerOverridesMetadata')
    ...
    operation_metadata: Optional[OperationMetadata] = Field(
        None, alias='OperationMetadata'
    )
    context_rule: Optional[ContextRule] = Field(None, alias='ContextRule')
    system_parameter_rule: Optional[SystemParameterRule] = Field(
        None, alias='SystemParameterRule'
    )
    import_admin_quota_policies_metadata: Optional[
        ImportAdminQuotaPoliciesMetadata
    ] = Field(None, alias='ImportAdminQuotaPoliciesMetadata')
    ...
    o_auth_requirements: Optional[OAuthRequirements] = Field(
        None, alias='OAuthRequirements'
    )
    ...
    logging_destination: Optional[LoggingDestination] = Field(
        None, alias='LoggingDestination'
    )
    import_admin_overrides_metadata: Optional[ImportAdminOverridesMetadata] = Field(
        None, alias='ImportAdminOverridesMetadata'
    )
    import_admin_quota_policies_response: Optional[
        ImportAdminQuotaPoliciesResponse
    ] = Field(None, alias='ImportAdminQuotaPoliciesResponse')
    type: Optional[Type] = Field(None, alias='Type')
    create_admin_quota_policy_metadata: Optional[
        CreateAdminQuotaPolicyMetadata
    ] = Field(None, alias='CreateAdminQuotaPolicyMetadata')
    method: Optional[Method] = Field(None, alias='Method')
    authentication_rule: Optional[AuthenticationRule] = Field(
        None, alias='AuthenticationRule'
    )
    ...
    batch_create_admin_overrides_response: Optional[
        BatchCreateAdminOverridesResponse
    ] = Field(None, alias='BatchCreateAdminOverridesResponse')
